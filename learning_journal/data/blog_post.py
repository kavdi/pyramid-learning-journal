...
POSTS = [
    {
        "post.date": datetime.strptime("2017-11-01", FMT),
        "post.title": "Day 12",
        "post_id": 12,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-30", FMT),
        "post.title": "Day 11",
        "post_id": 11,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-27", FMT),
        "post.title": "Day 9",
        "post_id": 9,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-26", FMT),
        "post.title": "Numero Ocho (Day 8)",
        "post_id": 8,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-25", FMT),
        "post.title": "Day 7",
        "post_id": 7,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-24", FMT),
        "post.title": "Day 6",
        "post_id": 6,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-22", FMT),
        "post.title": "Day 5",
        "post_id": 4,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-20", FMT),
        "post.title": "Day 3",
        "post_id": 3,
        "author": "kavdi",
    ...
    {
        "post.date": datetime.strptime("2017-10-18", FMT),
        "post.title": "Day 2",
        "post_id": 2,
        "author": "kavdi",
